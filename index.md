...
<head>
	...
	<style type="text/css">
		body{background-image: url(pictures/shallow10USC.jpg);background-repeat:repeat;}
		.topLeft{position:absolute;top:0px;left:0px;height:150px;width:150px;font-size:15pt}
		.navigation{position:absolute;top:150px;left:0px;width:200px}
			
		.right{position:absolute;left:200px;top:0px;font-size:11pt;color:black}
...
<body>
	...
	<div class="navigation">
		<br/><br/>
	    <p align="left" style="color:#990000">
		&nbsp&nbsp&nbsp&nbsp<a href="./documents/CV-Yuewei_Lin.pdf"><strong><big>Curriculum Vitae</big></strong></a>
		<br /><br />
		&nbsp&nbsp&nbsp&nbsp<a href="./education.html"><strong><big>Education</big></strong></a>
		<br /><br />
		&nbsp&nbsp&nbsp&nbsp<a href="#publications"><strong><big>Publications</big></strong></a>
                <br /><br />
                &nbsp&nbsp&nbsp&nbsp<img src="./pictures/barcode.gif" alt="yuewei_Lin-Chinese" width="100" height="100" /> <br />
	    </p>
	</div>
	<div class="right">
		<p align="center">
			<br />
                        <br /><br />
			<img src="pictures/ywlin1.jpg" alt="Yuewei Lin" width="420" height="370" /> <br /><br />
			Yuewei Lin <br />
			Ph.D Candidate<br />
			Department of Computer Science and Engineering<br />
			University of South Carolina<br /> &nbsp&nbsp<br />
			Email: ywlin.cq AT gmail.com, <a >lin59 AT email.sc.edu</a><br /><br />		
		<p />	


		<hr style="width:90%;" size="2" align="left" noshade="noshade" />
		<p ><strong><big>Curriculum Vitae</big></strong><p />
		<p ><a href="./documents/CV-Yuewei_Lin.pdf">Click here</a><p />

		<hr style="width:90%;" size="2" align="left" noshade="noshade" />
		<p ><strong><big><a name="education">Education</a></big></strong><p />
		<p >
			<ul>
				<li>
					Ph.D. Candidate in Computer Science & Engineering<br>
					University of South Carolina, Columbia, S.C. ~ Present<br>
				</li>
                                <br>
				<li>
					M.E. in Optical Engineering<br>
					Chongqing University, Chongqing, China.
				</li>
                                <br>	
				<li>
					B.S. in Optical Information Science & Technology<br>
		...
		<hr style="width:90%;" size="2" align="left" noshade="noshade" />
		<p ><strong><big><a name="research">Research</a></big></strong><p />
		<p >
			I am doing research in the <a href="http://cvl.cse.sc.edu/"> Computer Vision Lab</a> supervised by <a href="http://www.cse.sc.edu/~songwang/">Dr. Song Wang</a>.
		<p />
		
		<hr style="width:90%;" size="2" align="left" noshade="noshade" />
		<p ><strong><big><a name="publications">Publications (<a href="https://scholar.google.com/citations?user=wOFhljYAAAAJ&hl=en">Google Scholar</a>)</a></big></strong><p />
		<p ><strong><big>First Author Publications</big></strong><p /> <p >
			
<ul>
                                <li>Cross-Domain Recognition by Identifying Joint Subspaces of Source Domain and Target Domain (<a href="./documents/TCYB.pdf">PDF Coming Soon</a>) <br>
                                <strong>Y. Lin</strong>, J. Chen, Y. Cao, Y. Zhou, L. Zhang, Y. Y. Tang, S. Wang. <br>
                                     To appear in IEEE Transactions on Cybernetics.<br>
                                </li><br>
                                ...
                                <strong>Y. Lin</strong>, Y. Tong, Y. Cao, Y. Zhou, S. Wang. <br>
                                     To appear in IEEE Transactions on Circuits and Systems for Video Technology (TCSVT).<br>
                                </li><br>
				...
				<p ><strong><big>Co-Author Publications</big></strong><p /> <p >
                         	<ul>        
				...
				Neurocomputing, 103(1), pp.63-74, 2013.<br>
                        ...
                        <big><strong>Coming soon (hopefully...)</big></strong>
		</p>
		
		<hr style="width:90%;" size="2" align="left" noshade="noshade" /> 
	        <p ><strong><big><a name="award">Awards</a></big></strong><p />
			<ul>
				<li>Chinese Government Award for Outstanding Self-financed Student Abroad, 2015 </li>
				<li>Outstanding Graduate Researcher of the Department of Computer Science and Engineering, University of South Carolina, 2016.</li>
				<li>Best 10% Paper Award, International Conference on Image Processing, 2015</li>
				<li>IEEE Signal Processing Society Travel Grant, 2015.</li>
				<li>Graduate Student Travel Grant, Graduate School, University of South Carolina, 2015.</li>
			</ul>


		<hr style="width:90%;" size="2" align="left" noshade="noshade" />
                <p ><strong><big><a name="professional service">Professional Services</a></big></strong><p />
                <p ><strong><big>Reviewer</big></strong><p /> <p >
                        <ul>
                                <li>IEEE Transaction on Pattern Analysis and Machine Intelligence (IF: 5.781)</li>
                                <li>IEEE Transactions on Image Processing (IF: 3.625)</li>
				<li>Pattern Recognition (IF: 3.096)</li>
				<li>IEEE Transactions on Circuits and Systems for Video Technology (IF: 2.615)</li>
                                <li>IEEE Transactions on Intelligent Transportation Systems (IF: 2.377)</li>
				<li>Neurocomputing (IF: 2.083)</li>
				<li>Image and Vision Computing (IF: 1.587)</li>
				<li>Pattern Recognition Letters (IF: 1.551)</li>
                                <li>Computer Vision and Image Understanding (IF: 1.540)</li>
				<li>Optical Engineering (IF: 0.954)</li>
				<li>3D Research (Springer)</li>
				<li>CVPR Workshop on Looking at People, Boston, MA, 2015</li>
				<li>ICCV Workshop on Looking at People, Santiago, Chile, 2015</li>
				<li>International Conf. in Central Europe on Computer Graphics, Visualization and Computer Vision, Plzen, Czech Republic, 2015</li>
		
		</ul>	
		<p ><strong><big>Program Committee</big></strong><p /> <p >
                <ul>
				<li>CVPR Workshop on Looking at People, Boston, MA, 2015.</li>
				<li>ICCV Workshop on Looking at People, Santiago, Chile, 2015.</li>
		...
		<p ><strong><big>Student Volunteer</big></strong><p /> <p >
                <ul>
                                <li>24th AAAI Conference on Artificial Intelligence, Atlanta, GA, USA. July 2010.</li>
                ...
                <div> <script type="text/javascript" src="//ra.revolvermaps.com/0/0/8.js?i=00wef4q91c3&amp;m=0&amp;s=220&amp;c=ff0000&amp;cr1=ffffff&amp;f=arial&amp;l=33" async="async"></script>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-37559415-1']);
